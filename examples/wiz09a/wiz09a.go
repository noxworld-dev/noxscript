...
LABEL3:
	...
	ns.PrintToAll("Wiz09a:GainedCloak")
	goto LABEL5
LABEL4:
	goto LABEL5
LABEL5:
...
func MapInitialize() {
	...
	obj23 = ns.Object("JCloak")
	obj24 = ns.Object("JBoots")
	...
	wp49 = ns.Waypoint("WellWP")
	wp50 = ns.Waypoint("PlayerSounds")
...
func CapTakeoff() {
	if !(ns.IsCaller(ns.GetHost()) && flag52 == false) {
		goto LABEL1
	}
	flag52 = true
	ns.Delete(obj21)
...
func Secret01Declare() {
	...
	ns.MoveWaypoint(wp50, ns.GetObjectX(ns.GetTrigger()), ns.GetObjectY(ns.GetTrigger()))
	ns.AudioEvent(ns.SecretFound, wp50)
...
func MakeAWish() {
	...
	ns.AudioEvent(ns.RestoreHealthName, wp49)
}
func PlayMordwyn() {
	if !ns.IsCaller(ns.GetHost()) {
		goto LABEL1
