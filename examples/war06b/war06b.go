...
func horrendousTalk1Start() {
	...
	ns.ObjectGroupOff(gvar67)
	ns.TellStory(ns.DemonRecognize, "War06a:BoastfulHorrendous")
}
...
func necromancerTalk3Start() {
	ns.GroupPauseObject(gvar67, 10)
	ns.ObjectGroupOff(gvar67)
	ns.TellStory(ns.ZombieRecognize, "War06a:NecroAttackJack")
}
...
func necromancerTalk4Start() {
	ns.GroupPauseObject(gvar67, 10)
	ns.ObjectGroupOff(gvar67)
	ns.TellStory(ns.ZombieRecognize, "War06a:NecroDies")
}
...
func NecroInjured() {
	...
	if !(ns.CurrentHealth(obj55) < 50) {
		goto LABEL1
	}
	ns.RestoreHealth(obj55, 50)
LABEL1:
	return
}
func MakeAWish() {
