...
func InitializeGuardian() {
	...
	wp56 = ns.Waypoint("GuardianDoorWP")
...
func ClearGuardianDoor() {
	...
	ns.MoveObject(ns.GetCaller(), ns.GetWaypointX(wp56), ns.GetWaypointY(wp56))
LABEL1:
	return
}
func EnableKeeper() {
...
func InitializeKeeper() {
	...
	wp70[0] = ns.Waypoint("BlinkWP1")
	wp70[1] = ns.Waypoint("BlinkWP2")
	wp70[2] = ns.Waypoint("BlinkWP3")
	wp70[3] = ns.Waypoint("BlinkWP4")
	wp71 = ns.Waypoint("KeeperEnterWP")
	wp72 = ns.Waypoint("KeeperDoorWP")
	ns.LockDoor(obj67)
	ns.LockDoor(obj68)
}
func EnemyGoHome() {
...
LABEL2:
	...
	for {
		...
		v5[v0] = ns.Distance(v3, v4, ns.GetWaypointX(wp70[v0]), ns.GetWaypointY(wp70[v0]))
		v0 += 1
	}
LABEL3:
	v0 = 0
...
LABEL5:
	...
	v1 = ns.GetWaypointX(wp70[v7])
	v2 = ns.GetWaypointY(wp70[v7])
	if !(ivar75 >= 4) {
		goto LABEL9
	}
	ivar75 = 0
...
func KeeperEnter() {
	...
	v0 = ns.GetWaypointX(wp71)
	v1 = ns.GetWaypointY(wp71)
	if !(ns.IsCaller(ns.GetHost()) && flag74 == false) {
		goto LABEL1
	}
	ns.ObjectOn(obj69)
	ns.MusicPushEvent()
	...
	ns.AudioEvent(ns.TeleportIn, wp71)
...
func ClearKeeperDoor() {
	...
	ns.MoveObject(ns.GetCaller(), ns.GetWaypointX(wp72), ns.GetWaypointY(wp72))
LABEL1:
	return
}
func InitializeSkullGuns() {
	obj91 = ns.Object("ArrowTrap01")
	obj92 = ns.Object("ArrowTrap02")
	obj93 = ns.Object("ArrowTrap03")
	obj94 = ns.Object("ArrowTrap04")
	obj95 = ns.Object("ArrowTrap05")
	obj96 = ns.Object("ArrowTrap06")
	obj97 = ns.Object("ArrowTrap07")
	obj98 = ns.Object("ArrowTrap08")
	obj99 = ns.Object("ArrowTrap09")
	obj100 = ns.Object("ArrowTrap10")
	obj101 = ns.Object("ArrowTrap11")
}
func InitializeMonsterGroups() {
	gvar77 = ns.ObjectGroup("MonsterGroup01")
}
func MapInitialize() {
	wp48 = ns.Waypoint("AudioOrigin")
	wp76 = ns.Waypoint("SecretAudioOrigin")
	InitializeSkullGuns()
...
func SecretSFX() {
	ns.MoveWaypoint(wp76, ns.GetObjectX(ns.GetHost()), ns.GetObjectY(ns.GetHost()))
	ns.AudioEvent(ns.SecretFound, wp76)
}
func Secret01Found() {
	ns.ObjectOff(ns.GetTrigger())
