...
LABEL2:
	...
	for {
		...
		obj29[ivar21] = ns.CreateObject("SmallFlame", wp52[ivar21])
		ivar21 += 1
	}
LABEL11:
	gvar23 = gvar10
	ns.AudioEvent(ns.FireballCast, wp50)
...
LABEL3:
	...
	for {
		...
		ns.Delete(obj29[ivar21])
		obj29[ivar21] = ns.CreateObject("MediumFlame", wp52[ivar21])
		ivar21 += 1
	}
LABEL13:
	gvar23 = gvar11
	ns.AudioEvent(ns.DemonBreath, wp50)
...
LABEL4:
	...
	for {
		...
		ns.Delete(obj29[ivar21])
		obj29[ivar21] = ns.CreateObject("Flame", wp52[ivar21])
		ivar21 += 1
	}
LABEL15:
	gvar23 = gvar12
...
LABEL5:
	...
	for {
		...
		ns.Delete(obj29[ivar21])
		obj29[ivar21] = ns.CreateObject("LargeFlame", wp52[ivar21])
		ivar21 += 1
	}
LABEL17:
	gvar23 = gvar13
...
LABEL21:
	gvar23 = gvar15
	ns.AudioEvent(ns.FireExtinguish, wp50)
...
func ZombieAttackHecubah() {
	ns.WayPointGroupOn(gvar55)
	ns.WayPointGroupOff(gvar54)
...
func hecGone() {
	...
	ns.MoveObject(obj30, ns.GetWaypointX(wp49), ns.GetWaypointY(wp49))
	ns.ObjectOff(obj30)
LABEL1:
	return
}
...
func MapInitialize() {
	...
	for {
		...
		wp52[ivar21] = ns.Waypoint("FlameWay" + strconv.Itoa(ivar21+1))
		ivar21 += 1
	}
LABEL1:
	...
	obj41 = ns.Object("Zombie01")
	obj42 = ns.Object("Zombie02")
	obj43 = ns.Object("Zombie03")
	...
	wp50 = ns.Waypoint("FlameSound1")
	wp51 = ns.Waypoint("FlameSound2")
	wp48 = ns.Waypoint("AudioOrigin")
	wp53 = ns.Waypoint("WP")
	wp49 = ns.Waypoint("HecubahStorage")
	gvar54 = ns.WaypointGroup("BeforeSetpieceWay")
	gvar55 = ns.WaypointGroup("SetpieceWay")
	gvar56 = ns.WaypointGroup("AfterSetpieceWay")
	ns.WayPointGroupOff(gvar55)
	ns.WayPointGroupOff(gvar56)
	ns.Damage(obj38, 0, 100, 0)
	ns.Damage(obj39, 0, 100, 0)
	ns.Damage(obj40, 0, 100, 0)
...
func ResetFistTrap(a1 int) {
	...
	ns.MoveWaypoint(wp48, ns.GetObjectX(obj27[a1]), ns.GetObjectY(obj27[a1]))
