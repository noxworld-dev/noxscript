...
func ReleasePlayer() {
	...
	ns.ObjectOn(obj16)
LABEL1:
	ns.Delete(ns.Object("Wiz08a:CharmedWolf01"))
	ns.Delete(ns.Object("Wiz08a:CharmedWolf02"))
	ns.Delete(ns.Object("Wiz08a:CharmedWolf03"))
	ns.Delete(ns.Object("Wiz08a:CharmedWolf04"))
	ns.NoWallSound(true)
