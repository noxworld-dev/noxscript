...
func MapInitialize() {
	...
	wp105 = ns.Waypoint("Secret2AudioWP")
	gvar106 = ns.ObjectGroup("Secret200Group")
	gvar48 = ns.ObjectGroup("BlockTriggers")
	obj107 = ns.Object("Blocks2Trigger")
...
func Secret200XP() {
	...
	ns.PrintToAll("GeneralPrint:SecretFound")
	ns.AudioEvent(ns.SecretFound, wp105)
