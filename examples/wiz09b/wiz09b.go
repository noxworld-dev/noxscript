...
func MapInitialize() {
	...
	obj23 = ns.Object("Necromancer")
	obj24 = ns.Object("OgreDude")
...
LABEL2:
	if !(ns.IsCaller(ns.GetHost()) && flag66 == true && ns.CurrentHealth(obj4) > 0 && flag67 == false) {
		goto LABEL3
	}
	flag67 = true
	...
	ns.SetDialog(obj4, ns.NORMAL, AidanDialogStart, AidanDialogEnd)
	gvar62 = gvar58
	ns.CreatureGuard(obj4, ns.GetWaypointX(wp50), ns.GetWaypointY(wp50), ns.GetWaypointX(wp51), ns.GetWaypointY(wp51), 0)
	ns.BecomeEnemy(obj4)
	ns.SetOwner(ns.GetHost(), obj4)
LABEL3:
	return
