...
var (
	...
	wp71   ns.WaypointID
	obj72  ns.ObjectID
	gvar73 ns.ObjectGroupID
	wp74   [5]ns.WaypointID
	wp75   ns.WaypointID
	obj76  [2]ns.ObjectID
	obj77  [2]ns.ObjectID
	obj78  ns.ObjectID
...
func CreateCherub() {
	...
	v0 = ns.Random(0, 1)
	obj24[ivar69] = ns.CreateObject("EvilCherub", wp43[v0])
	...
	ns.SetCallback(obj24[ivar69], 5, CreateCherub)
	ns.SetRoamFlag(obj24[ivar69], 128)
	ns.AggressionLevel(obj24[ivar69], 0.83)
	ivar69 += 1
	goto LABEL2
LABEL1:
	return
...
func AllowAccess2() {
	...
	ns.ObjectOff(obj20)
	ns.ObjectOff(obj19)
	ns.AudioEvent(ns.Gear2, wp71)
}
func EnableRoom2() {
	PlayAction2Music()
	if !(ns.IsCaller(ns.GetHost()) && flag62 == false) {
		goto LABEL1
	}
	flag62 = true
	ns.LockDoor(obj12)
...
func InitializeVampireKnights() {
	obj76[0] = ns.Object("VampireKnight1")
	obj76[1] = ns.Object("VampireKnight2")
	obj77[0] = ns.Object("VKBat1")
	obj77[1] = ns.Object("VKBat2")
	wp79 = ns.Waypoint("VKSpot")
	wp80 = ns.Waypoint("VampireKnight1WP")
	wp81 = ns.Waypoint("BatCreate")
}
func PlaySubMusic() {
	ns.Music(18, 100)
}
func MapInitialize() {
	wp71 = ns.Waypoint("SentryAudioWP")
	...
	wp74[0] = ns.Waypoint("N1TeleWP0")
	wp74[1] = ns.Waypoint("N1TeleWP1")
	wp74[2] = ns.Waypoint("N1TeleWP2")
	wp74[3] = ns.Waypoint("N1TeleWP3")
	wp74[4] = ns.Waypoint("N1TeleWP4")
	wp9 = ns.Waypoint("OrbSoundWP")
	wp8 = ns.Waypoint("OrbEffectWP")
	wp43[0] = ns.Waypoint("CherubCreate1")
	wp43[1] = ns.Waypoint("CherubCreate2")
	gvar73 = ns.ObjectGroup("VampTriggers")
	gvar40 = ns.ObjectGroup("FinalLiches")
	gvar45 = ns.WallGroup("TreasureRoom1Walls")
	gvar46 = ns.WallGroup("TreasureRoom2Walls")
	gvar47 = ns.WallGroup("TreasureRoom3Walls")
	wp44 = ns.Waypoint("MechGolemAudioWP")
	gvar48 = ns.WallGroup("SecretRoomWall")
	gvar49 = ns.WallGroup("ForceOrbRoomWalls1")
	gvar50 = ns.WallGroup("Cage1")
	gvar51 = ns.WallGroup("Cage2")
	gvar52 = ns.WallGroup("Cage3")
	gvar53 = ns.WallGroup("Cage4")
	gvar54 = ns.WallGroup("AccessTreasureRoom3")
	gvar55 = ns.WallGroup("OpeningWall01")
	gvar56 = ns.WallGroup("WindowWall1")
	gvar57 = ns.WallGroup("WindowWall2")
	gvar58 = ns.WallGroup("LichStairAccess")
	gvar60 = ns.WallGroup("BlueKeyWallGroup")
	wp75 = ns.Waypoint("Secret1AudioWP")
	wp59 = ns.Waypoint("ExitAudioWP")
	PlaySubMusic()
...
func Necro1TeleportInjured() {
	...
	v2 = ns.Random(0, 4)
	v0 = ns.GetWaypointX(wp74[v2])
	v1 = ns.GetWaypointY(wp74[v2])
...
func BatToVampireKnight() {
	...
	fvar82 = ns.GetObjectX(ns.GetTrigger())
	fvar83 = ns.GetObjectY(ns.GetTrigger())
	ns.Delete(ns.GetTrigger())
	ns.ObjectOn(obj76[0])
LABEL1:
	ns.Effect(ns.BLUE_SPARKS, fvar82, fvar83, 0, 0)
	ns.Effect(ns.SMOKE_BLAST, fvar82, fvar83, 0, 0)
	ns.Enchant(obj76[0], ns.ENCHANT_INVISIBLE, 0.25)
	ns.MoveObject(obj76[0], fvar82, fvar83)
	ns.LookAtObject(obj76[0], ns.GetHost())
	flag84 = false
}
...
LABEL1:
	ns.Effect(ns.BLUE_SPARKS, fvar82, fvar83, 0, 0)
	ns.Effect(ns.SMOKE_BLAST, fvar82, fvar83, 0, 0)
	ns.Enchant(obj76[1], ns.ENCHANT_INVISIBLE, 0.25)
	ns.MoveObject(obj76[1], fvar82, fvar83)
	ns.LookAtObject(obj76[1], ns.GetHost())
}
func SetRetreatBat() {
	ns.AggressionLevel(obj78, 0.83)
	ns.SetCallback(obj78, 7, BatDie)
	ns.SetCallback(obj78, 5, BatDie)
}
func BatDie() {
	var (
		v0 ns.ObjectID
	...
	ns.Effect(ns.SMOKE_BLAST, ns.GetObjectX(ns.GetTrigger()), ns.GetObjectY(ns.GetTrigger()), 0, 0)
	ns.MoveWaypoint(wp81, ns.GetObjectX(ns.GetTrigger()), ns.GetObjectY(ns.GetTrigger()))
	ns.MoveObject(ns.GetTrigger(), ns.GetWaypointX(wp80), ns.GetWaypointY(wp80))
	ns.Delete(obj78)
	ns.AudioEvent(ns.BurnCast, wp81)
	v0 = ns.CreateObject("Flame", wp81)
	v1 = ns.CreateObject("MediumFlame", wp81)
	v2 = ns.CreateObject("SmallFlame", wp81)
...
func VKDie() {
	...
	fvar83 = ns.GetObjectY(ns.GetTrigger())
	ns.Delete(ns.GetTrigger())
	ns.MoveWaypoint(wp81, fvar82, fvar83)
	obj78 = ns.CreateObject("Bat", wp81)
