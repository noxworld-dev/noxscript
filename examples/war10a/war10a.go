...
func Blocks2MoveBack() {
	...
	ns.Move(obj46, wp55)
	ns.Move(obj47, wp56)
	ns.AudioEvent(ns.SpikeBlockMove, wp51)
}
func Blocks2Move() {
	...
	ns.Move(obj46, wp52)
	ns.Move(obj47, wp53)
	ns.AudioEvent(ns.SpikeBlockMove, wp54)
}
func OpenBlockWallGroup1() {
	ns.WallGroupOpen(gvar61)
}
...
func SkelGroup1Hostilize() {
	ns.GroupAggressionLevel(gvar64, 0.83)
}
...
func Blocks1Move() {
	...
	ns.Move(obj43, wp49)
	ns.Move(obj44, wp50)
	ns.AudioEvent(ns.SpikeBlockMove, wp57)
	ns.AudioEvent(ns.SpikeBlockMove, wp59)
...
func MapInitialize() {
	...
	wp48 = ns.Waypoint("Block1WP")
	wp49 = ns.Waypoint("Block2WP")
	wp50 = ns.Waypoint("Block3WP")
	wp51 = ns.Waypoint("Block4WP")
	wp52 = ns.Waypoint("Block5WP")
	wp53 = ns.Waypoint("Block6WP")
	wp54 = ns.Waypoint("Block4WPb")
	wp55 = ns.Waypoint("Block5WPb")
	wp56 = ns.Waypoint("Block6WPb")
	wp57 = ns.Waypoint("BlockAudioWP")
	wp58 = ns.Waypoint("BlockAudio2WP")
	wp59 = ns.Waypoint("BlockAudio3WP")
	wp60 = ns.Waypoint("BlockAudio4WP")
	obj105 = ns.Object("Blocks2Trigger")
	gvar61 = ns.WallGroup("BlockWallGroup1")
	gvar62 = ns.WallGroup("BlockWallGroup2")
	gvar63 = ns.WallGroup("BlockWallGroup3")
	gvar70 = ns.ObjectGroup("SkelBlockTrigGroup")
	...
	gvar64 = ns.ObjectGroup("SkelGroup1")
	gvar65 = ns.ObjectGroup("SkelGroup2")
	gvar66 = ns.ObjectGroup("SkelGroup3")
	gvar67 = ns.ObjectGroup("SkelGroup4")
	gvar68 = ns.ObjectGroup("SkelGroup5")
	gvar69 = ns.ObjectGroup("SkelGroup6")
