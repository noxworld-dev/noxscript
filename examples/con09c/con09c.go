...
func SwitchSpikeState() {
	ns.ObjectGroupOff(gvar66[ivar106])
	if !flag99 {
		goto LABEL1
	}
	ivar106 += 1
	...
	ivar106 = 0
LABEL2:
	ns.ObjectGroupOn(gvar66[ivar106])
...
func BeginPolling() {
	...
	if !(ns.CurrentHealth(obj21) <= 0 || !ns.IsAttackedBy(obj21, ns.GetHost())) {
		goto LABEL3
	}
	flag101 = true
...
LABEL3:
	goto LABEL4
LABEL2:
	if !(ns.CurrentHealth(obj22) <= 0 || !ns.IsAttackedBy(obj22, ns.GetHost())) {
		goto LABEL4
	}
	flag100 = true
	ns.Effect(ns.BLUE_SPARKS, ns.GetWaypointX(wp90), ns.GetWaypointY(wp90), 0, 0)
	ns.AudioEvent(ns.KeyDrop, wp90)
	ns.MoveObject(obj19, ns.GetWaypointX(wp90), ns.GetWaypointY(wp90))
	ns.ObjectOn(obj20)
	ns.Move(obj9, wp88)
	ns.Move(obj10, wp89)
	ns.Move(obj7, wp78)
...
func SpikeTimerAudioLoop() {
	...
	ns.FrameTimer(ivar103, SpikeTimerAudioLoop)
	ivar103 -= 1
	goto LABEL2
LABEL1:
...
func MapInitialize() {
	...
	obj107 = ns.Object("CreaturePitElev")
