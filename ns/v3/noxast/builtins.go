...
var builtins = []*builtinDef{
	asm.BuiltinWall:                      {Name: "Wall", Type: reflect.TypeOf(ns3.Wall)},
	...
	asm.BuiltinIsObjectOn:                {Name: "IsObjectOn", Type: reflect.TypeOf(ns3.IsObjectOn)},
	asm.BuiltinIsWaypointOn:              {Name: "IsWaypointOn", Type: reflect.TypeOf(ns3.IsWaypointOn)},
	asm.BuiltinIsLocked:                  {Name: "IsLocked", Type: reflect.TypeOf(ns3.IsLocked)},
	...
	asm.BuiltinIntToString:               {Name: "IntToString", Type: reflect.TypeOf(ns3.IntToString)},
	asm.BuiltinFloatToString:             {Name: "FloatToString", Type: reflect.TypeOf(ns3.FloatToString)},
	...
	asm.BuiltinGetHost:                   {Name: "GetHost", Type: reflect.TypeOf(ns3.GetHost)},
	asm.BuiltinObject:                    {Name: "Object", Type: reflect.TypeOf(ns3.Object)},
	asm.BuiltinGetObjectX:                {Name: "GetObjectX", Type: reflect.TypeOf(ns3.GetObjectX)},
	asm.BuiltinGetWaypointX:              {Name: "GetWaypointX", Type: reflect.TypeOf(ns3.GetWaypointX)},
	asm.BuiltinGetObjectY:                {Name: "GetObjectY", Type: reflect.TypeOf(ns3.GetObjectY)},
	asm.BuiltinGetWaypointY:              {Name: "GetWaypointY", Type: reflect.TypeOf(ns3.GetWaypointY)},
	asm.BuiltinGetObjectZ:                {Name: "GetObjectZ", Type: reflect.TypeOf(ns3.GetObjectZ)},
	asm.BuiltinGetDirection:              {Name: "GetDirection", Type: reflect.TypeOf(ns3.GetDirection)},
	...
	asm.BuiltinGetLastItem:               {Name: "GetLastItem", Type: reflect.TypeOf(ns3.GetLastItem)},
	asm.BuiltinGetPreviousItem:           {Name: "GetPreviousItem", Type: reflect.TypeOf(ns3.GetPreviousItem)},
	asm.BuiltinHasItem:                   {Name: "HasItem", Type: reflect.TypeOf(ns3.HasItem)},
	asm.BuiltinGetHolder:                 {Name: "GetHolder", Type: reflect.TypeOf(ns3.GetHolder)},
	asm.BuiltinPickup:                    {Name: "Pickup", Type: reflect.TypeOf(ns3.Pickup)},
	asm.BuiltinDrop:                      {Name: "Drop", Type: reflect.TypeOf(ns3.Drop)},
	asm.BuiltinHasClass:                  {Name: "HasClass", Type: reflect.TypeOf(ns3.HasClass)},
	asm.BuiltinUnused50:                  {Name: "Unused50", Type: reflect.TypeOf(ns3.Unused50)},
	asm.BuiltinHasEnchant:                {Name: "HasEnchant", Type: reflect.TypeOf(ns3.HasEnchant)},
	asm.BuiltinEnchantOff:                {Name: "EnchantOff", Type: reflect.TypeOf(ns3.EnchantOff)},
	asm.BuiltinCurrentHealth:             {Name: "CurrentHealth", Type: reflect.TypeOf(ns3.CurrentHealth)},
	asm.BuiltinMaxHealth:                 {Name: "MaxHealth", Type: reflect.TypeOf(ns3.MaxHealth)},
	asm.BuiltinRestoreHealth:             {Name: "RestoreHealth", Type: reflect.TypeOf(ns3.RestoreHealth)},
	asm.BuiltinDistance:                  {Name: "Distance", Type: reflect.TypeOf(ns3.Distance)},
	asm.BuiltinIsVisibleTo:               {Name: "IsVisibleTo", Type: reflect.TypeOf(ns3.IsVisibleTo)},
	...
	asm.BuiltinIsOwnedBy:                 {Name: "IsOwnedBy", Type: reflect.TypeOf(ns3.IsOwnedBy)},
	asm.BuiltinGroupIsOwnedBy:            {Name: "GroupIsOwnedBy", Type: reflect.TypeOf(ns3.GroupIsOwnedBy)},
	asm.BuiltinIsOwnedByAny:              {Name: "IsOwnedByAny", Type: reflect.TypeOf(ns3.IsOwnedByAny)},
	asm.BuiltinGroupIsOwnedByAny:         {Name: "GroupIsOwnedByAny", Type: reflect.TypeOf(ns3.GroupIsOwnedByAny)},
	asm.BuiltinClearOwner:                {Name: "ClearOwner", Type: reflect.TypeOf(ns3.ClearOwner)},
	asm.BuiltinWaypoint:                  {Name: "Waypoint", Type: reflect.TypeOf(ns3.Waypoint)},
	asm.BuiltinWaypointGroup:             {Name: "WaypointGroup", Type: reflect.TypeOf(ns3.WaypointGroup)},
	asm.BuiltinObjectGroup:               {Name: "ObjectGroup", Type: reflect.TypeOf(ns3.ObjectGroup)},
	asm.BuiltinWallGroup:                 {Name: "WallGroup", Type: reflect.TypeOf(ns3.WallGroup)},
	...
	asm.BuiltinGetQuestStatus:            {Name: "GetQuestStatus", Type: reflect.TypeOf(ns3.GetQuestStatus)},
	asm.BuiltinGetQuestStatusFloat:       {Name: "GetQuestStatusFloat", Type: reflect.TypeOf(ns3.GetQuestStatusFloat)},
	asm.BuiltinResetQuestStatus:          {Name: "ResetQuestStatus", Type: reflect.TypeOf(ns3.ResetQuestStatus)},
	asm.BuiltinIsTrigger:                 {Name: "IsTrigger", Type: reflect.TypeOf(ns3.IsTrigger)},
	asm.BuiltinIsCaller:                  {Name: "IsCaller", Type: reflect.TypeOf(ns3.IsCaller)},
	...
	asm.BuiltinGetElevatorStatus:         {Name: "GetElevatorStatus", Type: reflect.TypeOf(ns3.GetElevatorStatus)},
	...
	asm.BuiltinGetGold:                   {Name: "GetGold", Type: reflect.TypeOf(ns3.GetGold)},
	asm.BuiltinChangeGold:                {Name: "ChangeGold", Type: reflect.TypeOf(ns3.ChangeGold)},
	asm.BuiltinGetAnswer:                 {Name: "GetAnswer", Type: reflect.TypeOf(ns3.GetAnswer)},
	asm.BuiltinGiveXp:                    {Name: "GiveXp", Type: reflect.TypeOf(ns3.GiveXp)},
	asm.BuiltinHasSubclass:               {Name: "HasSubclass", Type: reflect.TypeOf(ns3.HasSubclass)},
	...
	asm.BuiltinIsTalking:                 {Name: "IsTalking", Type: reflect.TypeOf(ns3.IsTalking)},
	asm.BuiltinGetTrigger:                {Name: "GetTrigger", Type: reflect.TypeOf(ns3.GetTrigger)},
	asm.BuiltinGetCaller:                 {Name: "GetCaller", Type: reflect.TypeOf(ns3.GetCaller)},
	...
	asm.BuiltinIsSummoned:                {Name: "IsSummoned", Type: reflect.TypeOf(ns3.IsSummoned)},
	...
	asm.BuiltinIsGameBall:                {Name: "IsGameBall", Type: reflect.TypeOf(ns3.IsGameBall)},
	asm.BuiltinIsCrown:                   {Name: "IsCrown", Type: reflect.TypeOf(ns3.IsCrown)},
	...
	asm.BuiltinGetScore:                  {Name: "GetScore", Type: reflect.TypeOf(ns3.GetScore)},
}
